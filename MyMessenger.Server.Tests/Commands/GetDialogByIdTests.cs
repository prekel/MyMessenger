...
{
	[TestFixture]
	public class GetDialogByIdTests
	{
		[Test]
		public void CommandNameTest()
		{
			...
			{
				var cmd = new GetDialogById(context, server.Tokens, new GetDialogByIdParameters());
				Assert.AreEqual(CommandType.GetDialogById, cmd.CommandName);
			}
		}
